...
<div class="addContainer">
  <div class="d-flex flex-column justify-content-center form_container_2">
    <div class="addImageContainer">
      <img src="<?= base_url("assets/images/default.png"); ?>" class="brand_logo" alt="Logo" id="image_display">
    </div>
